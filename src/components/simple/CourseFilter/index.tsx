...
import { CourseFilterProps } from './props';

const OPTIONS = ['all', 'purchased', 'activated', 'deactivated'];

export const CourseFilter: React.FC<CourseFilterProps> = ({ onSearchSubmit, onFilterSelect }): React.JSX.Element => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center my-4">
      <div className="flex mr-2 relative rounded-md">
        ...
        />
        <Button onClick={(): void => onSearchSubmit(searchText)}>Search</Button>
      </div>
      <div className="relative text-gray-700">
        <select
          onChange={({ target: { value } }): void => onFilterSelect(value)}
